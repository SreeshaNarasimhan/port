...
export type Skill = {
  id: string;
  name: string;
  category: "Languages" | "AI & Data" | "Tools";
  icon: string;
};
export type Project = {
  id: string;
...
export const defaultData: PortfolioData = {
    ...
    cards: [
      {
        id: "1",
        title: "Curious",
        description: "Constantly exploring new AI tools, frameworks and ideas.",
        icon: "Sparkles",
      },
      {
        id: "2",
        title: "Collaborative",
        description: "Thrive in teams — communication first, ego last.",
        icon: "Users",
      },
      {
        id: "3",
        title: "Builder",
        description: "Prototype-driven mindset: ship, learn, iterate.",
        icon: "Hammer",
      },
    ],
  },
  ...
  softSkills: [
    {
      id: "ss1",
      title: "Communication",
      description: "Clear writing and presentation across technical and non-technical audiences.",
      icon: "MessageCircle",
    },
    {
      id: "ss2",
      title: "Teamwork",
      description: "Comfortable collaborating across roles, time zones, and tools.",
      icon: "Users",
    },
    {
      id: "ss3",
      title: "Problem Solving",
      description: "Break ambiguous problems into testable, shippable steps.",
      icon: "Lightbulb",
    },
  ],
  projects: [
    {
      ...
      title: "Coffee",
      description:
        "A responsive, animated coffee shop landing built with vanilla web technologies — focused on smooth UX and clean visual hierarchy.",
    ...
    },
    {
      ...
      description:
        "Classic ML pipeline — data cleaning, feature engineering, and a comparison of classifiers to predict passenger survival.",
    ...
    },
    {
      ...
      title: "Investa AI",
      description:
        "An AI-powered startup analyzer that scores ideas across market, team, and execution signals using LLM reasoning.",
    ...
    },
    {
      ...
      description:
        "A Figma UI/UX concept for an indoor campus wayfinding app — flows, components, and a polished design system.",
    ...
    {
      id: "p5",
      title: "Prompt-based Mini Games",
      description:
        "A collection of small browser games designed and iterated through prompt engineering with Gemini.",
  ...
  achievements: [
    {
      id: "a1",
      title: "Hack India — Spark 8 Participant",
      issuer: "Hack India",
      description:
        "Selected participant at Spark 8 — collaborated on a rapid prototype within 36 hours.",
      date: "2024",
    ...
    },
    {
      ...
      issuer: "NPTEL",
      description:
        "Completed Python for Data Science and LLM coursework with verified certification.",
      date: "2024",
      image: "https://images.unsplash.com/photo-1606326608606-aa0b62935f2b?w=1200&q=80",
    },
    {
      id: "a3",
      title: "Symposium Paper Presentations",
  ...
  experience: [
    {
      ...
      period: "2024",
      description: "Built internal tools and APIs with Python and modern web stack.",
    },
    {
      id: "e2",
      role: "Python Intern",
      company: "CodSoft",
      period: "2024",
      description: "Worked on automation scripts and small data projects.",
    },
    {
      id: "e3",
      role: "Content Writer",
      company: "Freelance",
      period: "2023 — Present",
      description: "Technical and non-technical writing across multiple clients.",
    },
  ],
  education: [
    {
      ...
      details: "Focused on machine learning, data engineering, and AI systems.",
    },
    {
      id: "ed2",
      ...
      school: "NPTEL",
      period: "2024",
      details: "Python for Data Science & LLM.",
    },
  ],
};
